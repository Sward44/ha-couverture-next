  ...
  <Html>
    ...
    <Body style={main}>
      <Section style={header}>
        <Img
          style={imgHeader}
          src={`${baseUrl}/ha-couverture-logo-336x160.png`}
          width={600}
          alt="codepen"
        />
      </Section>
      <Container style={container}>
        ...
        <Section style={section}>
          ...
          <Text style={text}>
            ...
            inspire a &#34;cool&#34; idea for your Pen. As always, the template
            is just as jumping off point. Feel free to incorporate the 🧊 in
            your creation, add more elements, or freeze it out completely and
          ...
          <Row>
            <Column style={ideas}>
              ...
              <Section style={yellowCard}>
                🌟
                <Text style={textCard}>
                  There&#39;s more to cubes than just six square sides. There
                  are variations on the cube that could be fun to play with this
                  week: <Link style={blueLink}>cuboid shapes</Link> are
                  hexahedrons with faces that aren&#39;t always squares. And if
                  you want to really push the boundaries of shape, consider the
                  4 dimensional <Link style={blueLink}>tesseract!</Link>
                </Text>
              </Section>
              ...
              <Section style={yellowCard}>
                🌟
                <Text style={textCard}>
                  Here&#39;s a mind-bending idea that can combine the round
                  shapes from week one with this week&#39;s cube theme:{" "}
            ...
            <Column style={resources}>
              ...
              <Section style={blueCard}>
                ...
                <Text style={textCard}>
                  ...
                  EntropyReversed&#39;s{" "}
                  <Link style={blueLink}>Pulsating Tesseract</Link>,
                  Josetxu&#39;s{" "}
...
const main = {
  fontFamily: "Mulish,Roboto,RobotoDraft,Helvetica,Arial,sans-serif",
  webFont: {
