                ...
                <>
                  ...
                  <div className="flex justify-center mb-4">
                    {status === "authenticated" && session ? (
                      <button onClick={handleForm} className="bg-neutral-300 text-neutral-950 py-2 px-4 rounded-xl md:hover:text-mahogany-950 md:hover:bg-supernova-500 transition-all duration-300 md:hover:scale-101 md:hover:shadow-ha">
                        Ajouter votre avis
                      </button>
                    ) : (
                      <Link href="/connexion" className="bg-neutral-300 text-neutral-950 py-2 px-4 rounded-xl md:hover:text-mahogany-950 md:hover:bg-supernova-500 transition-all duration-300 md:hover:scale-101 md:hover:shadow-ha">
                        Ajouter votre avis
                      </Link>
                    )}
                  </div>
