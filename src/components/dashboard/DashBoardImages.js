...
export function DashBoardImages({ meta }) {
  ...
  return (
    <div className="relative mb-4 flex h-full min-h-[180px] min-w-full sm:min-h-[360px] md:min-h-[420px] lg:min-h-[456px] lg:min-w-[860px] xl:min-h-[604px] xl:min-w-[1140px] 2xl:min-h-[740px] 2xl:min-w-[1400px]">
      <Image
        src={`${meta.url}`}
        fill
        alt={meta.alt}
