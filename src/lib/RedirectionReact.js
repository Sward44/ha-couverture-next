  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <Link href={`${url}`} aria-label={arialLabel}>
        <button
          className="relative w-48 rounded-xl bg-neutral-300 px-4 py-2 transition-all duration-300 md:hover:scale-101 md:hover:bg-supernova-500 md:hover:fill-mahogany-950 md:hover:text-mahogany-950 md:hover:shadow-ha"
